...
class Question(models.Model):
    ...
    right_option = models.ForeignKey(
        Option, on_delete=models.CASCADE, related_name='question')
...
class Test(models.Model):
    ...
    questions = models.ManyToManyField(
        Question, related_name="test", blank=True)
    description = models.CharField(max_length=280, blank=True)
    image_src = models.CharField(
        max_length=120, blank=True, default="https://source.unsplash.com/random")
